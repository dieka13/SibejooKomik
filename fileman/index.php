...
<div id="dlgAddFile">
  <form name="addfile" id="frmUpload" method="post" target="frmUploadFile" enctype="multipart/form-data">
    ...
    <input type="hidden" name="<?php echo $CI->security->get_csrf_token_name(); ?>" id="<?php echo $CI->security->get_csrf_token_name(); ?>" value="<?php echo $CI->security->get_csrf_hash(); ?>" />
    <div class="form">
      Select files to upload<br />
      <input type="file" name="files[]" id="fileUploads" multiple />
    </div>
  </form>
</div>
